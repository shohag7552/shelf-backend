...
# Project Structure: 
    ...
    │   │       ├── client.dart
    │   │       └── model.dart
    │   ├── auth/              # Authentication service/ jwt payload
    │   │   ├── auth_service.dart
    │   │   └── jwt_payload.dart
 ...
 * Use {orm} for database queries or curd operation.
   ...
   * After setup these, need to run {npx prisma generate} for generating client and models. In this project, these will generate in `lib/src/generated_prisma_client/` folder.
   ```
   npx prisma generate
   or
